      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <a href="#home" className="flex items-center space-x-2 text-blue-600 font-bold text-xl">
          ...
          <div className="hidden md:flex items-center space-x-4">
           <Link href='/auth/signup'>
            ...
            {/* <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 hover:-translate-y-0.5 shadow-sm hover:shadow-md">
              Apply Now
            </button> */}
          </div>
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
            ...
            <div className="pt-4 pb-2 border-t border-gray-200 space-y-2">
              ...
              {/* <button className="w-full text-left bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 text-base font-medium rounded-md transition-colors duration-200">
                Apply Now
              </button> */}
            </div>
          </div>
