  ...
  return (
    <div className="max-w-7xl  mx-auto p-8 py-20">
     ...
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div key={college.collegeId} className="mb-12 border p-6 rounded shadow">
          ...
          <form onSubmit={(e) => handleReviewSubmit(e, college.collegeId)} className="grid gap-4">
            <textarea
              name="review"
                ...
                {reviews
                  ...
                  .map((r, idx) => (
                    <li key={idx} className="border p-3 rounded bg-gray-50">
                      ...
                      <p className="text-yellow-600 font-semibold">Rating: {r.rating} ★</p>
                    </li>
                  ))}
              </ul>
            ) : (
